...
function getLocation() {
    if (navigator.geolocation) {
        ...
        function getWeather(position) {
            ...
            (0, _axiosDefault.default)(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=95e466ce1d456abc8f04d491faa6a64e&units=metric`).then(function(data) {
                return data;
...
const getBackgroundImage = ()=>{
    (0, _axiosDefault.default)("https://api.unsplash.com/photos/random/?client_id=fnid9p6DE2B1R50TKP6nrVaYyfp8Pbdtq0VTQX1rRxo").then(function(data) {
        return data;
    }).then(function(jsonData) {
        console.log(jsonData);
...
var Buffer = require("5e0994cee1553d33").Buffer;
"use strict";
/**
...
},{"5e0994cee1553d33":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../env/classes/FormData.js":"lSnyf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("1db980d4265e9c96");
var ieee754 = require("af771e2e6ece31d4");
...
},{"1db980d4265e9c96":"eIiSV","af771e2e6ece31d4":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
