...
function getLocation() {
  if (navigator.geolocation) {
    ...
    function getWeather(position) {
      ...
      axios(
        `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=95e466ce1d456abc8f04d491faa6a64e&units=metric`
      )
        .then(function (data) {
          return data;
        })
...
const getBackgroundImage = () => {
  axios(
    "https://api.unsplash.com/photos/random/?client_id=fnid9p6DE2B1R50TKP6nrVaYyfp8Pbdtq0VTQX1rRxo"
  )
    .then(function (data) {
      return data;
    })
